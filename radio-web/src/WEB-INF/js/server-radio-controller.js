 ...
 */
let ServerRadioController = function() {
...
Object.defineProperty(ServerRadioController.prototype, 'playAudio', {
	value: async function(index) {
		...
		try {
			...
			this.leftAudioSource = this.audioContext.createBufferSource();
...
Object.defineProperty(ServerRadioController.prototype, 'startFadeIn', {
	value: async function(index) {
		try {
			...
			this.rightAudioSource = this.audioContext.createBufferSource();
			...
			this.rightGainNode.gain.linearRampToValueAtTime(volumeSlider.value , this.audioContext.currentTime + 5.0);	//FADE IN
			this.leftGainNode.gain.linearRampToValueAtTime(0.0,this.audioContext.currentTime + 5.0);		//FADE OUT
			
			// this.leftAudioSource.ended = event => this.switchAudioSource();
			setTimeout(() => this.switchAudioSource(), this.audioContext.currentTime + 10.0);
